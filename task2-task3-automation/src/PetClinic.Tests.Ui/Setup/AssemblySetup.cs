...
/// <summary>
/// Runs once before any UI test. Only checks the UI itself — that's what's
/// relevant to this suite. If it fails, NUnit reports it as a fatal setup
/// error carrying the message from PetClinicAvailabilityChecker, and no
